...
function Help() {
  useEffect(() => {
    ...
    window.googletag.cmd.push(function() {
      window.googletag.defineSlot('/22678428348/SDPL_AP_Desktop_ATF_300X250', [300, 250], 'div-gpt-ad-1646037607193-0').addService(window.googletag.pubads());
   window.googletag.pubads().enableSingleRequest();
     window.googletag.pubads().disableInitialLoad();
      window.googletag.enableServices();
    });

    window.googletag.cmd.push(function() { window.googletag.display('div-gpt-ad-1646037607193-0'); });
  ...
  return (
    <div>
        <h1>Help</h1>
        <div id="div-gpt-ad-1646037607193-0" style={{minWidth: "300px", minHeight: "250px"}}></div>
